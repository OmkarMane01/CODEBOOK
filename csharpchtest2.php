...
{ 
  ...
  echo"<script language='javascript' type='text/javascript'> location.href='codcsharp.php' </script>";
}
elseif ($_POST['g'] == "b")
{ 
   echo "<script type='text/javascript'>alert('Select the Payment option  Credit Card.Thank you!')</script>";
  echo"<script language='javascript' type='text/javascript'> location.href='csharpCreditCard.php' </script>";
}
 elseif ($_POST['g'] == "c")
{ 
   echo "<script type='text/javascript'>alert('Select the Payment option   Debit Card.Thank you!')</script>";
  echo"<script language='javascript' type='text/javascript'> location.href='csharpDebitCard.php' </script>";
}else{ 
   echo "<script type='text/javascript'>alert('Select the Payment option plz. !')</script>";
  echo"<script language='javascript' type='text/javascript'> location.href='csharpchtest2.php' </script>";
}
}
?>
...
<div align="center">
  <table border="1" align="center" bgcolor="#000000" >
    <tr><td class="style3"><div align="center"> C# test</div></td>
   </tr>
</table><br />
...
<br />
		...
		<center><form action="csharpchtest2.php" method="post">
