...
<title>Certificate mysql-<?php echo $userRow['userName']; ?></title>
<style type="text/css">
...
$_name=$userRow['userName'];
 ...
 <h1>Mysql Programming Course</h1><br />
...
<?php
$query = "INSERT INTO sql (username,	total,	wrong	,mk,	per	,date) VALUES('$_name','$_tot',' $_w','$_mk','$per','$_date')";
