			     ...
			     if ( !$error)
                    {
                     ...
                     $query = "INSERT INTO DebitCard (AdharNo,CardNo ,CardHolder ,cvv ,	ExpireDate ,course) VALUES('$_uid','$_cardno','$_cardname','$_cvv','$_date','$_select ')";
			         mysqli_query($_conn,$query,$_conn);
             echo "<script type='text/javascript'>alert('Thanks.Payment succesfully done!.')</script>";
             echo "<script language='javascript' type='text/javascript'> location.href='start pythontest.php' </script>";
             }
