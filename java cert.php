...
<title>Certificate java-<?php echo $userRow['userName']; ?></title>
<style type="text/css">
...
<br /><br />
 ...
 <h1>JAVA Programming Course</h1><br />
 ...
 <td><?php echo $_w; ?></td>
  <td><?php echo $_mk; ?></td>
   ...
   <?php
$query = "INSERT INTO java (username,	total,	wrong	,mk,	per	,date) VALUES('$_name','$_tot',' $_w','$_mk','$per','$_date')";
