...
{ 
  ...
  echo"<script language='javascript' type='text/javascript'> location.href='codphp.php' </script>";
}
elseif ($_POST['g'] == "b")
{ 
...
{ 
  ...
  echo"<script language='javascript' type='text/javascript'> location.href='phpDebitCard.php' </script>";
}else{ 
   echo "<script type='text/javascript'>alert('Select the Payment option plz. !')</script>";
  echo"<script language='javascript' type='text/javascript'> location.href='phptest2.php' </script>";
}
}
?>
...
<title>phptest-<?php echo $userRow['userName']; ?></title>
<style type="text/css">
.style1{
...
<div align="center">
  <table border="1" align="center" bgcolor="#000000" >
    <tr><td class="style3"><div align="center">php test</div></td>
   </tr>
</table><br />
...
<br />
		...
		<center><form action="phptest2.php" method="post">
