...
{ 
  ...
  echo"<script language='javascript' type='text/javascript'> location.href='codjava.php' </script>";
}
elseif ($_POST['g'] == "b")
{ 
   echo "<script type='text/javascript'>alert('Select the Payment option  Credit Card.Thank you!')</script>";
  echo"<script language='javascript' type='text/javascript'> location.href='javaCreditCard.php' </script>";
}
 elseif ($_POST['g'] == "c")
{ 
   echo "<script type='text/javascript'>alert('Select the Payment option   Debit Card.Thank you!')</script>";
  echo"<script language='javascript' type='text/javascript'> location.href='javaDebitCard.php' </script>";
}else{ 
   echo "<script type='text/javascript'>alert('Select the Payment option plz. !')</script>";
  echo"<script language='javascript' type='text/javascript'> location.href='javatest2.php' </script>";
}
}
?>
...
<title>javatest-<?php echo $userRow['userName']; ?></title>
<style type="text/css">
.style1{
...
<div align="center">
  <table border="1" align="center" bgcolor="#000000" >
    <tr><td class="style3"><div align="center">Java test</div></td>
   </tr>
</table><br />
...
<br />
		...
		<center><form action="javatest2.php" method="post">
