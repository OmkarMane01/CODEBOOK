...
<title>Certificate HTML-<?php echo $userRow['userName']; ?></title>
<style type="text/css">
...
$_name=$userRow['userName'];
 ...
 <h1>HTML Programming Course</h1><br />
...
<?php
$query = "INSERT INTO html (username,	total,	wrong	,mk,	per	,date) VALUES('$_name','$_tot',' $_w','$_mk','$per','$_date')";
