...
{ 
  ...
  echo"<script language='javascript' type='text/javascript'> location.href='mysqlCreditCard.php' </script>";
}
 elseif ($_POST['g'] == "c")
{ 
   echo "<script type='text/javascript'>alert('Select the Payment option   Debit Card.Thank you!')</script>";
  echo"<script language='javascript' type='text/javascript'> location.href='mysqlDebitCard.php' </script>";
}else{ 
   echo "<script type='text/javascript'>alert('Select the Payment option plz. !')</script>";
  echo"<script language='javascript' type='text/javascript'> location.href='mysqltest2.php' </script>";
}
}
?>
...
<title>mysqltest-<?php echo $userRow['userName']; ?></title>
<style type="text/css">
.style1{
...
<div align="center">
  <table border="1" align="center" bgcolor="#000000" >
    <tr><td class="style3"><div align="center">mysql test</div></td>
   </tr>
</table><br />
...
<br />
		...
		<center><form action="mysqltest2.php " method="post">
