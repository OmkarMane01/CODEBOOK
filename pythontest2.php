...
{ 
  ...
  echo"<script language='javascript' type='text/javascript'> location.href='codpython.php' </script>";
}
elseif ($_POST['g'] == "b")
{ 
   echo "<script type='text/javascript'>alert('Select the Payment option  Credit Card.Thank you!')</script>";
  echo"<script language='javascript' type='text/javascript'> location.href='pythonCreditCard.php' </script>";
}
 elseif ($_POST['g'] == "c")
{ 
   echo "<script type='text/javascript'>alert('Select the Payment option   Debit Card.Thank you!')</script>";
  echo"<script language='javascript' type='text/javascript'> location.href='pythonDebitCard.php' </script>";
}else{ 
   echo "<script type='text/javascript'>alert('Select the Payment option plz. !')</script>";
  echo"<script language='javascript' type='text/javascript'> location.href='pythontest2.php' </script>";
}
}
?>
...
<title>pythontest-<?php echo $userRow['userName']; ?></title>
<style type="text/css">
.style1{
...
<div align="center">
  <table border="1" align="center" bgcolor="#000000" >
    <tr><td class="style3"><div align="center">python test</div></td>
   </tr>
</table><br />
...
<br />
		...
		<center><form action="pythontest2.php" method="post">
