...
<title>Python Debit Card -<?php echo $userRow['userName']; ?></title>
<style type="text/css">
.style1{
...
<div align="center">
  <table border="1" align="center" bgcolor="#000000" >
    <tr><td class="style3"><div align="center">debit card </div></td>
   </tr>
</table><br />
<table width="950" align="center" bgcolor="#000000">
 <tr><td width="942"><div align="center">
 <h4><center><form action="pythonDebitCard2.php " method="post" autocomplete="off">
