...
{ 	
  ...
  echo"<script language='javascript' type='text/javascript'> location.href='pythontest.php' </script>";
}
...
2). If user want a certificate of Python language then give the test.<br />
...
Have a good day <?php echo $userRow['userName']; ?>.<br />
		...
		<center><form action="pythontest.php" method="post">
