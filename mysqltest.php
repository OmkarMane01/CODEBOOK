...
{ 	
  ...
  echo"<script language='javascript' type='text/javascript'> location.href='mysqltest.php ' </script>";
}
...
2). If user want a certificate of Mysql language then give the test.<br />
...
Have a good day <?php echo $userRow['userName']; ?>.<br />
		...
		<center><form action="mysqltest.php " method="post">
