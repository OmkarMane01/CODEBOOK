...
<title>Certificate Python-<?php echo $userRow['userName']; ?></title>
<style type="text/css">
...
<br /><br />
 ...
 <h1>Python Programming Course</h1><br />
...
<?php
$query = "INSERT INTO python (username,	total,	wrong	,mk,	per	,date) VALUES('$_name','$_tot',' $_w','$_mk','$per','$_date')";
