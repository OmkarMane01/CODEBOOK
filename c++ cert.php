...
$_tot3=$_count21+$_count23+$_count23+$_count24+$_count25+$_count26+$_count27+$_count28+$_count29+$_count30;
$_tot=$_tot1+$_tot2+$_tot3;
$_w=$_tot-30;
$_mk=$_tot*2;
$per=(($_mk*100)/60);
...
<title>Certificate C++-<?php echo $userRow['userName']; ?></title>
<style type="text/css">
...
<br /><br />
 ...
 <?php
$query = "INSERT INTO cpp (username,	total,	wrong	,mk,	per	,date) VALUES('$_name','$_tot',' $_w','$_mk','$per','$_date')";
