...
{ 	
  ...
  echo"<script language='javascript' type='text/javascript'> location.href='phptest.php ' </script>";
}
...
2). If user want a certificate of Php language then give the test.<br />
...
Have a good day <?php echo $userRow['userName']; ?>.<br />
		...
		<center><form action="phptest.php " method="post">
