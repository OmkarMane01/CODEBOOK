...
{ 
  ...
  echo"<script language='javascript' type='text/javascript'> location.href='htmlch4.php' </script>";
}else
{ 	
...
<div align="center">
 ...
 <tr><td width="942"><div align="center" class="style2"><strong>03.ELEMENTS</strong></div></td>
 </tr>
 <tr>
   <td class="style5"><strong>HTML element:</strong></td>
 </tr>
 <tr><td>
...
<center><img src="images/element.jpg"  /></center>
<span class="style5"><br />
Nested HTML Elements:</span> <br />
It is very much allowed to keep one HTML element inside another HTML element:<br />
<center><img src="images/nested element.jpg" /></center>
...
<b>What is the use of div Tag?.</b>
</td></tr>
<tr><td>
<input type="Checkbox" name="g" value="a">  This is paragraph content .<br>
<input type="Checkbox" name="g" value="b">  This is heading content.<br>
<input type="Checkbox" name="g" value="c">  This isitalic conten.<br>
<input type="Checkbox" name="g" value="d">  This is division content.<br>
<input class="check" name="go" type="submit" value="Check"  /></td></tr>
</form></table>
 <br />
  
<div align="center">
<a href="htmlch2.php"><input class="button1" name="login2" type="submit" value="<<Previos" size="15" /></a>
<a href="html-index.php"><input name="submit"  type="submit" class="button2" value="index" size="15" /></a>
 <a href="htmlch4.php"><input class="button3" name="login" type="submit" value="Next>>" size="15" /></a></div>
