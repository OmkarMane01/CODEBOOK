...
{ 
  ...
  echo"<script language='javascript' type='text/javascript'> location.href='cod.php' </script>";
}
elseif ($_POST['g'] == "b")
{ 
   echo "<script type='text/javascript'>alert('Select the Payment option  Credit Card.Thank you!')</script>";
  echo"<script language='javascript' type='text/javascript'> location.href='Credit Card.php' </script>";
}
 elseif ($_POST['g'] == "c")
{ 
   echo "<script type='text/javascript'>alert('Select the Payment option   Debit Card.Thank you!')</script>";
  echo"<script language='javascript' type='text/javascript'> location.href='Debit Card.php' </script>";
}else{ 
...
<br />
		...
		<center><form action="C++test (2).php" method="post">
